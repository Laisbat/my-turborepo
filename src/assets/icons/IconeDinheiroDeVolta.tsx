...
// coloque um console.log pra gente ver a color que está sendo passada
const IconeDinheiroDeVolta = ({
  color,
  ...props
}: React.SVGProps<SVGSVGElement>) => {
  const theme = useTheme();
  console.log("IconeDinheiroDeVolta color:", color);

  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 382.6 400"
      fill="none"
      {...props}
    >
      <g>
...
export default IconeDinheiroDeVolta;
