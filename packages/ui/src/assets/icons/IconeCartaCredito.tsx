...
const IconeCartaCredito = (props: React.SVGProps<SVGSVGElement>) => {
  const theme = useTheme();
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 364.3 400"
      fill="none"
      {...props}
    >
      <g>
...
export default IconeCartaCredito;
